...
st.markdown("---")
st.caption("Note: AI is used for structured extraction and patient education only. Risk values are calculated by the Python implementation of the fit10 model.")
